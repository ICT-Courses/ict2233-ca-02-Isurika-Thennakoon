...
export default function Home() {
  return (
    ...
    >
      ...
      {/* Right Side - Text */}
      <div className="md:w-1/2 md:pl-12 text-center md:text-left bg-white/70 p-6 rounded-xl shadow-lg">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-800 md-6 max-w-lg"> I am currently pursuing a <strong>Bsc in Information Technology(IT)</strong> and I am passionate about technology, software development, and problem-solving. I enjoy learning new programming language, building projects, and exploring areas such as web development, networking, and data analytics. my goal is to develop my skills further and contribute effectively to innovative tech solutions.</p>
        ...
        <div className="flex gap-4 justify-center md:justify-start">
          ...
          <a
            href="/contact"
            className="border border-gray-600 text-blue-600 px-6 py-3 rounded-xl hover:bg-black-50 dark:hover:bg-gray-800 transition"
          >
            Contact Me
          </a>
        </div>
